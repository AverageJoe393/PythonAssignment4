...
class PlayersYear:
    ...
    def __str__(self):
        return "%-13s%10s%10s%10s%10s%10s%10s%10.3f%10.3f" %(self.__player, self.__year, self.__stats[4], self.singles(), self.__stats[1], self.__stats[2], self.__stats[3], self.batting_average(), self.slugging_percentage())
